import { POST } from "@/app/api/admin/conditions/[id]/approve/route";
...
describe("POST /api/admin/conditions/[id]/approve", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("should update condition to PUBLISHED when admin approves", async () => {
    vi.mocked(auth).mockResolvedValue({ user: { id: "admin-1", role: "ADMIN" } } as any);
